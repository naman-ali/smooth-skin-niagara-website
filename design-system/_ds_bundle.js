...
(() => {
  const __ds_ns = (window.SmoothSkinNiagaraDesignSystem_31611e =
    ...
    (() => {
      ...
      function Button({
        ...
        const base = {
          ...
          flexShrink: 0,
          transition:
            "background var(--duration-normal) var(--ease-standard), border-color var(--duration-normal) var(--ease-standard), opacity var(--duration-fast) var(--ease-standard)",
  ...
  try {
    ...
    __ds_ns.__errors.push({
      path: "components/core/IconCircle.jsx",
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    ...
    __ds_ns.__errors.push({
      path: "components/navigation/NavDropdown.jsx",
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    ...
    __ds_ns.__errors.push({
      path: "components/navigation/PhoneCallout.jsx",
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    (() => {
      function GoogleReviews({ rating = "5.0", count = 61 }) {
        return /*#__PURE__*/ React.createElement(
          "div",
          {
            style: {
    ...
    __ds_ns.__errors.push({
      path: "components/trust/GoogleReviews.jsx",
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    (() => {
      function StatItem({ icon, value, label, divider = true }) {
        return /*#__PURE__*/ React.createElement(
          "div",
          {
            style: {
    ...
    __ds_ns.__errors.push({
      path: "components/trust/StatItem.jsx",
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    (() => {
      function TestimonialQuote({ quote, author, rating = 5 }) {
        return /*#__PURE__*/ React.createElement(
          "div",
          {
            style: {
    ...
    __ds_ns.__errors.push({
      path: "components/trust/TestimonialQuote.jsx",
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    ...
    __ds_ns.__errors.push({
      path: "components/trust/TrustStrip.jsx",
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    ...
    __ds_ns.__errors.push({
      path: "tailwind/tailwind.config.js",
      error: String((e && e.message) || e),
    });
  }
  ...
  try {
    (() => {
      const { Button, IconCircle } =
        window.SmoothSkinNiagaraDesignSystem_31611e;
      const { NavDropdown, PhoneCallout } =
        window.SmoothSkinNiagaraDesignSystem_31611e;
      const { GoogleReviews, TrustStrip, StatItem, TestimonialQuote } =
        window.SmoothSkinNiagaraDesignSystem_31611e;
      const Arrow = () =>
        /*#__PURE__*/ React.createElement(
          "svg",
      ...
      function Header() {
        return /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(PhoneCallout, null),
            /*#__PURE__*/ React.createElement("span", {
              style: {
                width: 1,
                height: 32,
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                ...
                "Advanced laser technology meets personalized care for long-lasting results and beautifully smooth skin.",
              ),
              /*#__PURE__*/ React.createElement(
                "div",
                {
              ...
              /*#__PURE__*/ React.createElement(GoogleReviews, null),
            ),
          ),
          /*#__PURE__*/ React.createElement(
            "div",
        ...
        const rightTestimonials = [
          {
            quote: /*#__PURE__*/ React.createElement(
              ...
              ", and truly amazing at what she does. She makes you feel ",
              /*#__PURE__*/ React.createElement(
                "strong",
                null,
          ...
          },
          {
            quote: /*#__PURE__*/ React.createElement(
              ...
              ", talking me through appointments and the entire process.",
            ),
            author: "Stephanie D",
          },
        ];
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                ...
                "Ashley is the founder of Smooth Skin Niagara and personally performs every treatment. With more than 10 years of experience, she is known for her thoughtful, professional approach and her ability to make every client feel comfortable and confident right away.",
              ),
    ...
    __ds_ns.__errors.push({
      path: "ui_kits/website/Homepage.jsx",
      error: String((e && e.message) || e),
    });
  }
