...
function TreatmentCard({ card }: { card: TreatmentCard }) {
  return (
    <div
      className={cn(
        "group flex flex-col overflow-hidden transition-all duration-200 ease-out hover:-translate-y-[3px]",
        "bg-[var(--olive-100)] rounded-[24px]",
      )}
      style={{
    ...
    >
      <div className="relative aspect-[4/3] w-full overflow-hidden">
        ...
        <span
          className={cn(
            "absolute left-4 top-4 rounded-full px-3 py-1.5 text-[10px] font-semibold uppercase tracking-[0.16em]",
            "bg-[rgba(251,250,247,0.92)] text-[var(--olive-700)] font-[var(--font-body)]",
          )}
        >
          {card.badge}
        </span>
      ...
      <div
        className={cn(
          "flex flex-col items-center px-6 pb-8 pt-6 text-center",
          "gap-[4px]",
        )}
      >
        <h3
          className={cn(
            "font-normal",
            "font-[var(--font-display)] text-[38px] leading-[1.1] text-[var(--ink-900)] m-0",
          )}
        >
          {card.name}
        </h3>
        ...
        <span
          className={cn(
            ...
            "font-[var(--font-body)] text-[var(--olive-600)] mb-[8px]",
          )}
        >
          {card.descriptor}
        </span>
        ...
        <p
          className={cn(
            ...
            "font-[var(--font-body)] text-[var(--ink-600)] mt-0 mr-0 mb-[24px] ml-0 max-w-[280px]",
          )}
        >
          {card.description}
        </p>

        <span className={cn("h-px w-12", "bg-[var(--olive-300)] mb-[20px]")} />

        <span
          className={cn(
            "text-[11px] font-semibold uppercase tracking-[0.16em]",
            "font-[var(--font-body)] text-[var(--ink-600)]",
          )}
        >
          {card.priceLabel}
        </span>
        ...
        <span
          className={cn(
            "font-normal",
            "font-[var(--font-display)] text-[50px] leading-[1.05] text-[var(--ink-900)] mt-[4px] mr-0 mb-[12px] ml-0",
          )}
        >
          {card.price}
        </span>
        ...
        <p
          className={cn(
            ...
            "font-[var(--font-body)] text-[var(--ink-600)] m-0",
          )}
        >
          {card.maintenance}
        </p>
...
export function FindYourLook({ id }: { id?: string }) {
  return (
    <section id={id} className={cn("py-24 md:py-32", "bg-[var(--olive-50)]")}>
      <div className={cn("mx-auto w-full px-3 lg:px-12", "max-w-[1400px]")}>
        <div className="mb-16 flex flex-col items-center text-center">
          ...
          <h2
            className={cn(
              "font-normal",
              "font-[var(--font-display)] text-[60px] leading-[1.05] text-[var(--ink-900)] mt-0 mr-0 mb-[24px] ml-0 text-center",
            )}
          >
            Lashes,{" "}
            <em className={cn("font-normal italic", "text-[var(--olive-700)]")}>
              Your Way.
            </em>
          </h2>
          ...
          <p
            className={cn(
              ...
              "font-[var(--font-body)] text-[var(--ink-600)] max-w-[720px] text-center m-0",
            )}
          >
