  ...
  return (
    <Card className="border-border shadow-sm">
      <CardContent className="flex flex-col items-center gap-4 py-14 text-center">
        ...
        <h1 className="font-display text-3xl font-medium text-olive-700">
          Thank you
        </h1>
        ...
        <p className="max-w-sm text-sm text-muted-foreground">
          If we need any additional information before your treatment,
          we&apos;ll let you know.
        </p>
        <Button
          type="button"
          size="lg"
          onClick={onDone}
          className="mt-4 h-12 min-w-[160px] text-base"
        >
          Done
        </Button>
      </CardContent>
